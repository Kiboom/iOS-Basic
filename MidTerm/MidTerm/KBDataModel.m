...
- (void)initializeData {
    ...
    Reachability *reachability = [Reachability reachabilityWithHostName:@"http://125.209.194.123/json.php"];
    
    if([reachability currentReachabilityStatus]){
        NSURLRequest *request = [[NSURLRequest alloc] initWithURL:[[NSURL alloc] initWithString:@"http://125.209.194.123/json.php"]];
        self.jsonData = [NSURLConnection sendSynchronousRequest:request
